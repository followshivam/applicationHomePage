...
const LeftContainer=(props)=>{
    ...
    const enableBatching = event => {
        setBatching(event.target.checked)
    }

    const batchingChange = event => {
    ...
    return(   
        <Paper className={classes.paperLeft} elevation={0}>
            <Typography textAlign='left' variant="subtitle1" style={{ marginLeft: '-10px' }}>
                <Checkbox
                    size= 'small'
            ...
            <>
            <Grid container >
                <Typography inline textAlign='left' variant="h6" ><b>Batch Size</b></Typography>
                <Input type='number' disableUnderline={true} className={classes.inputBatching} autoFocus={true} onChange={batchingChange} />
            </Grid>
            <Grid container>
            ...
            <Grid container justify='space-between'>
                <Typography inline textAlign='left' variant="subtitle1">
                    Select the fields you want for KeyField.
                </Typography>
